...
_SPREE_DECOMPOSE = (
    ...
    "FIRST check whether PROGRESS.md already exists at the repo root with a "
    "## TASKS checklist. If it does, this is a RESUME of an earlier run — DO NOT "
    "overwrite it or reset any checked `- [x]` boxes. Just read it, optionally "
    "append any clearly-missing tasks under ## TASKS, and stop. Otherwise, create "
    "it fresh:\n\n"
